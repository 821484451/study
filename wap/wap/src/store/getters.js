...
// 充值折扣
export const agentRate = state => state.agentRate
export const benefitType = state => state.benefitType
//  我的所有游戏
export const myAllGame = state => state.myAllGame
export const qrCodeUrl = state => state.qrCodeUrl
// 结算信息
export const settleInformation = state => state.settleInformation
export const bankList = state => state.bankList
export const rate = state => state.rate
export const html = state => state.html
// 获取用户信息
export const userInfo = state => state.userInfo
export const totalData = state => state.totalData
// 公告消息
export const msgList = state => state.msgList
export const msgCount = state => state.msgCount
export const msgDetail = state => state.msgDetail
