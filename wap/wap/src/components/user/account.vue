    ...
    <div class="main">
      <div class="content">
        ...
        <ul class="menu">
          ...
          <li class="menu_li"><router-link to="bindingmobile">绑定手机<i>{{userInfo.mobile}}&nbsp;&nbsp;<img src="../../assets/images/huosdk_tg_back_002.png" alt=""></i></router-link></li>
          <li class="menu_li"><router-link to="/message">平台公告<i><!-- <span>8</span> -->&nbsp;&nbsp;<img src="../../assets/images/huosdk_tg_back_002.png" alt=""></i></router-link></li>
        </ul>
      </div>
    </div>
  </div>
