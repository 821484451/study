    ...
    <div class="main">
      <div class="sum">
        <div class="sum_div1">
          ...
          <p class="sum_div1__p2">{{userDetail.shareRemain}}</p>
        </div>
        <div class="sum_div2">
    ...
    <div class="addChannel" v-if="popAddChannel" @touchmove.prevent>
      <div class="addChannelBox">
        ...
        <div class="inputList">
          ...
          <div class="inputBox">
            <span class="inputBox_name">平台币数量：</span>
            <input type="text" class="inputBox_input">
          </div>
          <div class="inputBox">
      ...
      <div class="addChannelBox">
        ...
        <div class="inputList">
          ...
          <div class="inputBox">
            ...
            <input type="password" class="inputBox_input">
          </div>
        </div>
        <div class="addChannelBox_footer">
          <a href="javascript:;" @click.stop="popCash()">取消</a>
          <a href="javascript:;" @click.stop="popCash()">确定</a>
        </div>
      </div>
    </div>
