  ...
  <div class="home">
    <div class="main">
      <div class="head">
        <div class="headImg">
          <router-link to="/account">
            ...
            &nbsp;&nbsp;
            <span>{{userDetail.userLogin}}</span>
          </router-link>
        </div>
        <div class="headBtn">
      ...
      <div class="total">
        ...
        <MyEchart :widthLength="width" v-if="detail"/>
      </div>
    </div>
    <div id="test"></div>
    <Footer :flag="flag"/>
...
export default {
  ...
  watch: {
    curMonth (curVal, oldVal) {
      store.dispatch('monthWater', {'start_time': (new Date()).getFullYear() + '-' + curVal + '-01', 'end_time': (new Date()).getFullYear() + '-' + curVal + '-31'})
    }
  },
  data () {
    return {
