    ...
    <div class="main">
      <div class="chargeList">
        <ul class="chargeList_list">
          <li class="chargeList_list__li list" v-for="(item, index) in playerPayList" :key="index" @click="toDetail('/payrecorddetail', index)">
            <div class="list_div1">
...
export default {
  ...
  methods: {
    toDetail (url, num) {
      this.$router.push({path: url, query: {mem_id: this.$route.query.memId, agent_id: this.$route.query.agentId, num: num}})
    }
  }
}
</script>
